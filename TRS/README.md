...
## Zone parameter configuration:
    ...
    for example:
        "jb_zoneCfg 1.0 -0.5 8.0 10.0 70.0 -150.0 -0.01 \x0d\x0a"
    zone parameter:
...
![MainMenu 1](https://github.com/bigheadG/imageDir/blob/master/trs-ex4.png)

## Reference:

1. LabGuide: https://github.com/bigheadG/mmWaveDocs/blob/master/V20_TMD_18xx_68xx_traffic_monitoring_users_guide.pdf
2. KeyDataProtocol: https://github.com/bigheadG/mmWaveDocs/blob/master/V20_TRS_Protocol_for_KEY_data_Project_V2015B01_pdf.pdf 
