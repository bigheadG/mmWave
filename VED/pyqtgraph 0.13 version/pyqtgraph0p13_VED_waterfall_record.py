#=============================================
# File Name: pyqtgraph_VED_waterfall_record.py
#
# Requirement:
...
v8_col_names_rt = ['fN','time','v8']
def radarExec(writer):
...
def uartThread(name):
	...
	with open(getFileName(), 'w', newline='') as csvfile:
		...
		writer.writerow(v8_col_names_rt)
		while True:
			radarExec(writer)
			csvfile.flush()
